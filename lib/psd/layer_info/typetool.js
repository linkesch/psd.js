...
(function() {
  var Descriptor, LayerInfo, TextElements, reduce, parseEngineData,
  ...
  module.exports = TextElements = (function(superClass) {
    ...
    TextElements.prototype.fontStyles = function() {
      var data = this.engineData.EngineDict.StyleRun.RunArray.map(function (r) {
        return r.StyleSheet.StyleSheetData;
      });
    ...
    TextElements.prototype.textDecoration = function() {
      ...
      data = data.map(function (f) {
        return f.Underline ? 'underline' : 'normal';
      });
